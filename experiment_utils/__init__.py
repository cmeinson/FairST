...
def get_all_result_files():
    s_files, s_datasets, s_titles = get_all_single_attr_files()
    m_files, m_datasets, m_titles = get_all_multi_attr_files()
