...
epochs = 100
n_repetitions = 2
results_filename = "bareusing_models_"
other = {}
...
for e in range(1):
    for dataset, dim in zip(datasets, latent_dims):
        for s in [["race"]]: #  ["sex","race"],["race"],["sex"]
            ...
            mls_MLP = eq_MLP +  vae_MLP + [
                ...
                #(Tester.LFR, Model.MLP_C, other={"c":"LFR"}, sensitive_attr = s), #base_model_bias_mit=Tester.REWEIGHING
