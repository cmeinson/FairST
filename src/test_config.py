...
class TestConfig:
    ...
    def __init__(
        ...
        bias_mit: str,
        ml_method: str,
        bias_ml_method: Optional[str] = None,
        preprocessing: Optional[str] = None,
        base_model_bias_mit: Optional[str] = None,
        ...
        self.base_model_bias_mit = base_model_bias_mit  # for post proc methods
        self.other = other
        self.n_cols = None
    ...
    def __str__(self):
        ...
        other_attrs = [f"{key}={value}" for key, value in self.other.items()]
